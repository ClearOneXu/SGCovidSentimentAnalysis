...
from keras.layers import Embedding, Conv1D, MaxPooling1D, Flatten, Dense, Input, GlobalMaxPooling1D, Dropout, concatenate
...
if do_early_stopping:
    ...
    history = model.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=8, batch_size=128, callbacks = [early_stopping, tensorboard])
else:
